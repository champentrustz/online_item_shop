...
<div class="w-full h-full overflow-hidden flex flex-col gap-4">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0ZM3.75 12h.007v.008H3.75V12Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm-.375 5.25h.007v.008H3.75v-.008Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
   ...
   <div class="text-red-400 text-xs">(รีเซ็ตทุกวันจันทร์เวลา 00:00)</div>
...
<div class=" h-full w-full grid grid-cols-5 gap-1 overflow-auto content-start" style="min-width: 0;" id="items-content"></div>
</div>
...
`);
    ...
    if(items.length !== 0){
        items && items.slice(0).reverse().map((item)=>{
            ...
            $('#items-content').append(renderItemList(item))
        })
    }
